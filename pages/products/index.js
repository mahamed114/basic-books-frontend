...
export default function Products({ productData }) {
  return (
    <>
      <Head>
        <title>Products | Basic Books</title>
        <meta
          name="description"
      ...
      <div className="flex">
        ...
        <div className="grid grid-rows-2 gap-6">
          ...
          <div style={{ marginLeft: "202px", marginTop: "50px" }}>
            ...
            <div className="grid grid-cols-3 gap-10 mx-auto mt-4 px-8 w-[1000px]">
              <h4 className="text-[#57C4E5] flex">NAME</h4>
            ...
            {productData.map((product) => {
              return (
                <div
                  key={product.id}
                  className="grid grid-cols-3 gap-x-10 gap-y-2 min-w-fit mx-auto px-8 w-[1000px]"
                >
                  <>
                    ...
                    <h3 className="">{product.item_type}</h3>
                    <h3 className="">{product.item_sale_price}</h3>
                  </>
                </div>
              );
            })}
