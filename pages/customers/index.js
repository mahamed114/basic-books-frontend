...
export default function Customers({ customersData }) {
  return (
    <>
      <Head>
        <title>Customers | Basic Books</title>
        <meta
          name="description"
        ...
        <div className="grid grid-rows-2 gap-6">
          ...
          <div style={{ marginLeft: "202px", marginTop: "50px" }}>
            ...
            <div className="grid grid-cols-4 gap-x-4 mx-auto mt-4 px-4 w-[1000px]">
              <h4 className="text-[#57C4E5]">NAME</h4>
            ...
            {customersData.map((customer) => {
              return (
                <div
                  key={customer.id}
                  className="grid grid-cols-4 gap-x-4 mx-auto gap-y-2 px-4 w-[1000px]"
                >
                  <>
                    <Link href={`/customers/${customer.id}`}>
                      <h3 className="flex overflow-x-hidden">
                    ...
                    <h3 className="ml-8">{customer.cus_company}</h3>
                    <h3 className="">{customer.cus_email}</h3>
                    <h3 className="">{customer.cus_mobile}</h3>
                  </>
                </div>
              );
            })}
